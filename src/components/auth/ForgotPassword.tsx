...
const ForgotPassword: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage(translate('auth.forgotPassword.resetSent'));
    } catch (err) {
      console.error('Password reset error:', err);
      setError(translate('auth.errors.resetFailed'));
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            >
              ...
              {loading ? translate('auth.forgotPassword.sending') : translate('auth.forgotPassword.resetPassword')}
            </button>
          </div>
        </form>
        ...
        <div className="text-center mt-4">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            {translate('auth.forgotPassword.rememberPassword')}{' '}
